...
class AnswerInputField extends DataObject implements ScaffoldingProvider
{
    ...
    private static $db = [
        'Label' => 'Varchar(255)',
        'InputType' => 'Enum("text, email, textarea, rich text editor, product aspects, date, release date, url, multiple-choice: single selection, multiple-choice: multiple selection", "text")',
        'Required' => 'Boolean',
        'MinLength' => 'Int',
        'MaxLength' => 'Int',
